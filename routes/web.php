...
Route::group(['namespace'=>'Frontend', 'middleware' => ['ipcheck','check_refer']], function() {
    ...
    // web.php or api.php (if using API)
...
Route::group(['namespace'=>'Admin','middleware' => ['auth','lock','check_refer'],'prefix'=>'admin'], function() {
    ...
    Route::post('smsgeteway/save', [ApiIntegrationController::class,'sms_update'])->name('smsgeteway.update');
        ...
        // smtp configuration
    Route::get('smtp/manage', [ApiIntegrationController::class, 'smtp_manage'])->name('smtp.manage');
    Route::post('smtp/save', [ApiIntegrationController::class, 'smtp_update'])->name('smtp.update');

    // Fraud API configuration
    Route::get('fraudapi/manage', [FraudapiController::class, 'fraudapi_manage'])->name('fraudapi.manage');
    Route::post('fraudapi/save', [FraudapiController::class, 'fraudapi_update'])->name('fraudapi.update');
