...
<body data-layout-mode="default" data-theme="light" data-layout-width="fluid" data-topbar-color="dark"
  ...
  <!-- Begin page -->
  <div id="wrapper" style="background-color: #F3EDFF; min-height: 100vh;">
    <!-- Topbar Start -->
      ...
      <div class="container-fluid">
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
          ...
          <li class="dropdown d-none d-xl-block">
            <a class="nav-link dropdown-toggle waves-effect waves-light" href="{{route('home')}}" target="_blank"> <i
                data-feather="globe"></i> Visit Site </a>
          </li>
        </ul>
    ...
    <!-- ========== Left Sidebar Start ========== -->
    <div class="left-side-menu" style="background-color: #F3EDFF;">
      <div class="h-100" data-simplebar>
        ...
        <div id="sidebar-menu">
          <style>
            #sidebar-menu {
              background: linear-gradient(135deg, #C0EDE4, #C0EDE4);
              color: white;
            }
            ...
            /* Hover এবং Active effect */
            #sidebar-menu a:hover,
            #sidebar-menu .active>a {
              background: linear-gradient(135deg, #6C47E0, #8E2DE2);
              /* স্টাইলিশ বেগুনি গ্রেডিয়েন্ট */
          ...
          <ul id="side-menu">
            ...
            <li>
              ...
              <div class="collapse" id="siebar-product">
                <ul class="nav-second-level">
                  ...
                  <li>
                    <a href="{{route('coupon')}}"><i data-feather="file-plus"></i> Coupons</a>
                  </li>
            ...
            <li>
              <a href="{{ route('fraudapi.manage') }}"><i data-feather="shield"></i> Fraud API</a>
            </li>
            <!-- nav items end -->
            <li>
              <a href="{{route('smtp.manage')}}"><i class="fas fa-envelope"></i> Mail SMTP</a>
            </li>
            <!-- nav items end -->
            <!-- <li>
                  <a href="{{ route('customers.ip_block') }}">
                      <i class="fas fa-ban"></i> IP Block
                  </a>
              </li> -->
    ...
    <div class="content-page">
      ...
      <footer class="footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 text-end">&copy; {{$generalsetting->name}} <a href="https://solutionitbd.com"
                target="_blank">Solution It BD</a></div>
          </div>
        </div>
      </footer>
      <!-- end Footer -->
