                        ...
                        <form action="{{route('admin.order.update')}}" method="POST" class="row pos_form"
                                        ...
                                        @foreach($cartinfo as $key => $value)
                                            <tr>
                                                ...
                                                <td><button type="button" class="btn btn-danger btn-xs cart_remove"
                                                        data-id="{{$value->rowId}}"><i class="fa fa-times"></i></button></td>
                                            </tr>
                                            @php
                            ...
                            <div class="col-sm-6">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-2">
                                            <input type="number" id="additional_phone"
                                                class="form-control @error('additional_phone') is-invalid @enderror"
                                                placeholder="Additional Number (Optional)" name="additional_phone"
                                                value="{{$shippinginfo->additional_phone}}">
