                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('admin.order_change')}}" method="POST" class=row data-parsley-validate=""
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                        id="name" value="{{$data->shipping ? $data->shipping->name : ''}}" placeholder="Name">
                                    @error('name')
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                        name="phone" id="phone" value="{{$data->shipping ? $data->shipping->phone : ''}}"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    <label for="additional_phone" class="form-label">Additional Phone Number </label>
                                    <input type="text" class="form-control @error('additional_phone') is-invalid @enderror"
                                        name="additional_phone" id="additional_phone"
                                        value="{{$data->shipping ? $data->shipping->additional_phone : ''}}"
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="address"
                                        class="form-control @error('address') is-invalid @enderror">{{$data->shipping ? $data->shipping->address : ''}}</textarea>
                                    @error('address')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <select type="area" id="area" class="form-control @error('area') is-invalid @enderror"
                                        name="area" required>
                                    ...
                                    <select class="form-control select2-multiple @error('status') is-invalid @enderror"
                                        ...
                                        <optgroup>
                                            ...
                                            @foreach($orderstatus as $value)
                                                <option value="{{$value->id}}" @if($data->order_status == $value->id) selected
