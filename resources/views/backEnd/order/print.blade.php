                                    ...
                                    <td style="width:60%;float: left;">
                                        ...
                                        <div class="invoice-bar"
                                            ...
                                            <p
                                                ...
                                                Invoice Date:
                                                <strong>{{$order->created_at->format('d-m-y')}}</strong></span></p>
                                        </div>
                                        <div class="invoice_to" style="padding-top: 20px;">
                                            ...
                                            @if($order->shipping && $order->shipping->additional_phone)
                                                <p style="font-size:16px;line-height:1.8;color:#222;text-align: right;">
                                                    {{$order->shipping->additional_phone}}</p>
                                            @endif
                                            <p style="font-size:16px;line-height:1.8;color:#222;text-align: right;">
                            ...
                            <div class="invoice-bottom">
                                ...
                                <div class="terms-condition"
                                    ...
                                    <p style="text-align: center; font-style: italic; font-size: 15px; margin-top: 10px;">*
                                        This is a computer generated invoice, does not require any signature.</p>
                                </div>
                            </div>
                        </div>
                    </div>
