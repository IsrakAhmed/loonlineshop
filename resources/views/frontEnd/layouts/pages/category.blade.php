                             ...
                             <div class="pro_price">
                                ...
                                @if (!$value->prosizes->isEmpty() || !$value->procolors->isEmpty())
                                    <div class="pro_btn d-flex justify-content-between align-items-center gap-2">
                                        ...
                                        <a href="{{ route('product', $value->slug) }}" class="btn btn-sm btn-success w-100" style="flex: 1;">
                                            অর্ডার করুন
                                        </a>
                                ...
                                @else
                                    <div class="pro_btn d-flex justify-content-between align-items-center gap-2">
                                        <!-- অর্ডার করুন বাটন -->
                                        <a class="btn btn-sm btn-success w-100 addcartbutton" data-id="{{ $value->id }}" data-checkout="yes" style="flex: 1;">
                                            অর্ডার করুন
                                        </a>

                                        <!-- কার্ট আইকন বাটন -->
                                        <a class="btn btn-sm btn-outline-success addcartbutton" data-id="{{ $value->id }}" style="width: 40px; padding: 4px;">
                                            <i class="fas fa-shopping-cart"></i>
                                        </a>
                                    </div>
                                @endif
