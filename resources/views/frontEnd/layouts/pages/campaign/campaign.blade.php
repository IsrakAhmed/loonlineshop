            ...
            <div class="col-sm-12">
                <div class="campaign_content">
                    ...
                    <div class="comapaign_text">
                        ...
                        <div class="campaign_review"><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                                class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>
                            <span>{{$campaign_data->review}}</span></div>
                        <div class="cam_description">{!! $campaign_data->description !!}</div>
                        <a href="#order_form" class="cam_order_now" id="cam_order_now"><i
                                class="fa-solid fa-angle-right"></i> অর্ডার করতে ক্লিক করুন </a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="cam_discount">
                    <div class="card">
                        <div class="card-header">
                            ...
                            {{number_format($discount, 0)}}% ডিসকাউন্ট এ এখনি অর্ডার করুন</div>
                        <div class="card-body">
                            <p class="cam_price"><del> {{$product->old_price}} টাকা </del> {{$product->new_price}} টাকা
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="name"
                                                ...
                                                value="{{old('name')}}" placeholder="নাম" required>
                                            @error('name')
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-3">
                                            <label for="additional_phone">অতিরিক্ত মোবাইল (ঐচ্ছিক)</label>
                                            <input type="number" minlength="11" id="additional_phone" maxlength="11"
                                                pattern="0[0-9]+"
                                                title="please enter number only and 0 must first character"
                            ...
                            <table class="cart_table table table-bordered table-striped text-center mb-0">
                                ...
                                <tbody>
                                    @foreach(Cart::instance('shopping')->content() as $value)
                                        <tr>
                                            <td>
                                                <a href="{{route('product', $value->options->slug)}}"><i
